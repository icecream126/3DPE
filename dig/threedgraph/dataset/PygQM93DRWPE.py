...
class QM9RWPE(InMemoryDataset):
    ...
    def __init__(self,k, cutoff): 
        ...
        self.cutoff = cutoff
        super(QM9RWPE, self).__init__('./dataset/qm9/lappe/')
    ...
    def raw_file_names(self):
        return 'qm9_rwpe_k_'+str(self.k)+'_cutoff_'+str(self.cutoff)+'.npz'

    @property
    def processed_file_names(self):
        return 'qm9_rwpe_k_'+str(self.k)+'_cutoff_'+str(self.cutoff)+'.pt'
    ...
    def process(self):
        ...
        print('Saving rwpe with k = '+str(self.k)+' and cutoff = '+str(self.cutoff)+'...')
