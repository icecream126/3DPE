...
from lap_eig_eig import LapEigEig
...
class QM9LapEigEig(InMemoryDataset):
    ...
    def __init__(self,k, cutoff): 
        ...
        self.cutoff = cutoff
        super(QM9LapEigEig, self).__init__('../dataset/qm9/lappe/')
...
if __name__=="__main__":
    ...
    dataset = QM9LapEigEig(data_list = data_list, k=k, cutoff=cutoff) # Change these parameters as you want
    print(dataset.data)
