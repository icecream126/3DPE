...
sys.path.append('/home/hyomin126/3DPE/dig/threedgraph/positional_encoding')
sys.path.append('/home/hyomin126/3DPE/dig/threedgraph/dataset')


from eig import EigenvaluePE
...
class QM9EigPE(InMemoryDataset):
    
    # def __init__(self,k, cutoff): 
    def __init__(self, data_list, cutoff) : # Before first processing
    ...
    # def __init__(self, cutoff): 
        ...
        self.cutoff = cutoff
        super(QM9EigPE, self).__init__('../dataset/qm9/lappe/')
    ...
    def __str__(self):
        return f"cutoff is {self.cutoff}"

    @property
    def raw_file_names(self):
        return 'qm9_eigpe_cutoff_'+str(self.cutoff)+'.npz'

    @property
    def processed_file_names(self):
        return 'qm9_eigpe_cutoff_'+str(self.cutoff)+'.pt'
        return 'qm9_eigpe_cutoff_'+str(self.cutoff)+'.pt'
    ...
    def process(self):
        ...
        print('Saving eigpe with cutoff = '+str(self.cutoff)+'...')
...
if __name__=="__main__":
    ...
    for data in origdataset:
        ...
        data.pe = eigpe(data.pos.shape[0], edge_index)
        data_list.append(data)
        print('Processed # of data : ',cnt,' / ',len(origdataset))
        cnt+=1

    dataset = QM9EigPE(data_list = data_list, cutoff=cutoff) # Change these parameters as you want
    print(dataset.data)
